                            ...
                            <div className="card-body">
                                ...
                                <div className="mb-3">
                                    ...
                                    >
                                        ...
                                        <option value="APPROVAL">{locale === 'ja' ? '稟議' : '품의'}</option>
                                        <option value="ORDERED">{locale === 'ja' ? '発注' : '발주'}</option>
                                        <option value="SHIPPING">{locale === 'ja' ? '配送' : '배송'}</option>
                                        <option value="DELIVERED">{locale === 'ja' ? '設置完了' : '설치완료'}</option>
                                    </select>
                                </div>
