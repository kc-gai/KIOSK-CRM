                    ...
                    {activeStep === 3 && (
                        <div className="card">
                            ...
                            <div className="card-body">
                                <div className="datagrid">
                                    <div className="datagrid-item">
                                        <div className="datagrid-title">품의서 제목</div>
                                        <div className="datagrid-content">{process.approvalTitle || '-'}</div>
                                    </div>
                                    <div className="datagrid-item">
                                        <div className="datagrid-title">그룹웨어 ID</div>
                                        <div className="datagrid-content">{process.approvalRequestId || '-'}</div>
                                    </div>
                                </div>

                                {!process.step3CompletedAt && process.currentStep === 3 && (
                                    <div className="mt-4">
                                        <button className="btn btn-outline-primary me-2">
                    ...
                    {activeStep === 4 && (
                        <div className="card">
                            ...
                            <div className="card-body">
                                <div className="datagrid">
                                    <div className="datagrid-item">
                                        <div className="datagrid-title">{t('approvalStatus')}</div>
                                        <div className="datagrid-content">
                                    ...
                                    <div className="datagrid-item">
                                        <div className="datagrid-title">승인일</div>
                                        <div className="datagrid-content">{formatDate(process.approvalDate)}</div>
                                    </div>
                                    <div className="datagrid-item" style={{ gridColumn: 'span 2' }}>
                                        <div className="datagrid-title">승인자 코멘트</div>
                                        <div className="datagrid-content">{process.approvalComment || '-'}</div>
                                    </div>
                                </div>

                                {!process.step4CompletedAt && process.currentStep === 4 && (
                                    <div className="mt-4">
                                        <button className="btn btn-outline-primary me-2">
                                        ...
                                        <div className="card">
                                            <div className="card-body">
                                                <div className="d-flex align-items-center">
                                                    <span className={`avatar me-3 ${process.vendorOrderSent ? 'bg-success' : 'bg-secondary'}`}>
                                                        <Send size={18} />
                                                    </span>
                                                    <div>
                                                        <div className="fw-bold">{t('vendorOrderSent')}</div>
                                                        <div className="text-muted small">{process.vendorEmail || '이메일 미설정'}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
