                    ...
                    <div className="card-body">
                        <div className="row g-3">
                            <div className="col-sm-6 col-lg-4">
                                <Link href="/dashboard/statistics/orders" className="card card-link card-link-pop">
                                    <div className="card-body d-flex align-items-center">
                                        <span className="avatar bg-blue-lt me-3">
                                            <i className="ti ti-chart-line"></i>
                                        </span>
                                        <div>
                                            <div className="fw-semibold">{t('monthlyOrderTrend')}</div>
                                            <div className="text-muted small">{t('monthlyOrderTrendDesc')}</div>
                                        </div>
                                        <i className="ti ti-chevron-right ms-auto text-muted"></i>
                                    </div>
                                </Link>
                            </div>
                            <div className="col-sm-6 col-lg-4">
                                <Link href="/dashboard/statistics/regions" className="card card-link card-link-pop">
                                    <div className="card-body d-flex align-items-center">
                                        <span className="avatar bg-green-lt me-3">
                                            <i className="ti ti-map-pin"></i>
                                        </span>
                                        <div>
                                            <div className="fw-semibold">{t('regionAssetDist')}</div>
                                            <div className="text-muted small">{t('regionAssetDistDesc')}</div>
                                        </div>
                                        <i className="ti ti-chevron-right ms-auto text-muted"></i>
                                    </div>
                                </Link>
                            ...
                            <div className="col-sm-6 col-lg-4">
                                <Link href="/dashboard/statistics/partners" className="card card-link card-link-pop">
                                    <div className="card-body d-flex align-items-center">
                                        <span className="avatar bg-orange-lt me-3">
                                            <i className="ti ti-chart-pie"></i>
                                        </span>
                                        <div>
                                            <div className="fw-semibold">{t('partnerOrderShare')}</div>
                                            <div className="text-muted small">{t('partnerOrderShareDesc')}</div>
                                        </div>
                                        <i className="ti ti-chevron-right ms-auto text-muted"></i>
                                    </div>
                                </Link>
                            ...
                            <div className="col-sm-6 col-lg-4">
                                <Link href="/dashboard/statistics/deliveries" className="card card-link card-link-pop">
                                    <div className="card-body d-flex align-items-center">
                                        <span className="avatar bg-purple-lt me-3">
                                            <i className="ti ti-truck-delivery"></i>
                                        </span>
                                        <div>
                                            <div className="fw-semibold">{t('deliveryStats')}</div>
                                            <div className="text-muted small">{t('deliveryStatsDesc')}</div>
                                        </div>
                                        <i className="ti ti-chevron-right ms-auto text-muted"></i>
                                    </div>
                                </Link>
                            ...
                            <div className="col-sm-6 col-lg-4">
                                <Link href="/dashboard/statistics/kiosks" className="card card-link card-link-pop">
                                    <div className="card-body d-flex align-items-center">
                                        <span className="avatar bg-cyan-lt me-3">
                                            <i className="ti ti-device-desktop"></i>
                                        </span>
                                        <div>
                                            <div className="fw-semibold">{t('kioskStatusStats')}</div>
                                            <div className="text-muted small">{t('kioskStatusStatsDesc')}</div>
                                        </div>
                                        <i className="ti ti-chevron-right ms-auto text-muted"></i>
                                    </div>
                                </Link>
                            ...
                            <div className="col-sm-6 col-lg-4">
                                <Link href="/dashboard/statistics" className="card card-link card-link-pop bg-primary-lt">
                                    <div className="card-body d-flex align-items-center">
                                        <span className="avatar bg-primary me-3">
                                            <i className="ti ti-chart-bar"></i>
                                        </span>
                                        <div>
                                            <div className="fw-semibold">{t('allStatistics')}</div>
                                            <div className="text-muted small">{t('allStatisticsDesc')}</div>
                                        </div>
                                        <i className="ti ti-chevron-right ms-auto text-muted"></i>
                                    </div>
                                </Link>
